...
pp.auto <- read.table("C:/Data/Actuariat/Reserving/data/ppauto_pos.csv", sep=",", header = T, stringsAsFactors = F)
pp.auto<- rename_(pp.auto, .dots = c("incurred"="IncurLoss_B",
                                         "cum.paid"="CumPaidLoss_B",
                                         "earned.prm.dir"="EarnedPremDIR_B",
                                         "earned.prm.net"="EarnedPremNet_B",
                                         "claim.year"="AccidentYear",
                                         "dev.year"="DevelopmentYear"))

pp.auto<-mutate(pp.auto, lag=dev.year-claim.year, CY=claim.year+lag)
...
data.prep<-DataPrep(pp.auto, split = "claim.year", lag="lag", id = "CY")
